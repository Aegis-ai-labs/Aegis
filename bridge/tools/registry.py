...
import json
from bridge.tools import health, wealth, web_search
...
TOOL_DEFINITIONS = [
    ...
    {
        "name": "search_web",
        "description": "Search the web for current information, recent news, or research. Use when user asks about current events, latest trends, recent research, or needs up-to-date information beyond your knowledge cutoff.",
        "input_schema": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Search query (e.g., 'latest health research on sleep 2026', 'current stock market trends')"
                },
                "max_results": {
                    "type": "integer",
